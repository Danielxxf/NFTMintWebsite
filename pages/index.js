  ...
  async function Mint(how_many_nfts) {
    ...
    if (rightNetwork) {
      if (contract) {
        ...
        var gasAmount = await contract.methods.mintCats(how_many_nfts).estimateGas({from: walletAddress, value: price})
    ...
    <div>
      ...
      <nav className="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div className="container px-4 px-lg-5">
          <a className="navbar-brand" href="#page-top">Byte Land</a>
          ...
          <div className="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
            ...
            <div className="col-lg-8 align-self-baseline">
              <p className="text-white-75 mb-5" style={{fontSize: '1.4rem'}}>
                Some curious cats came to the Byte Land to adventure.<br />
                ...
                Only 25 ftm each.Take home and take care of them!
              </p>
              ...
              <MintButton onClick={() => Mint(how_many_nfts)} saleStarted={saleStarted} nfts={how_many_nfts} signedIn={signedIn} price={nftPrice} />
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="container px-4 px-lg-5">
          <div className="row gx-4 gx-lg-5 justify-content-center">
            <div className="col-lg-8 col-xl-6 text-center" style={{color: '#212529'}}>
              <h2 className="mt-0">Adventure still continues...</h2>
            </div>
          </div>
        </div>
      </section>
